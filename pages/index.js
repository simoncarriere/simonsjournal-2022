...
export default function Home({ posts }) {
  ...
  return (
    <main className="mx-8 sm:mx-16 lg:mx-20 xl:mx-32">
      ...
      {/* ----- HEADING ----- */}
      <header className="flex items-center justify-center pt-48 lg:pt-0 max-h-screen">
          ...
          <div className="max-w-2xl mt-16">
            ...
            <div className="flex flex-col w-full mt-4 xl:flex-row 2xl:mt-8 space-between pr-24">
              ...
              <div className="flex mr-4 xl:block basis-1/2 hover:cursor-pointer ">
                <img src="/images/prj-1.png" className="hover:brightness-95 object-cover h-20 rounded-lg w-28  xl:h-32 2xl:h-44  xl:w-full"/>
              ...
              <div className="flex mt-4 mr-4 xl:block basis-1/2 hover:cursor-pointer xl:mt-0">
                <img src="/images/prj-2.png" className="hover:brightness-95 object-cover h-20 rounded-lg w-28 xl:h-16 2xl:h-44 xl:w-full"/>
                <div className="h-full my-auto ml-4 xl:ml-0">
