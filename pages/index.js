...
export default function Home({ posts }) {
  ...
  return (
    <main className="mx-32 pt-20 2xl:pt-0">

      {/* ----- Heading ----- */}
      <header className="flex items-center justify-center 2xl:min-h-screen">
        <div className="basis-1/2">
          ...
          <div className="max-w-2xl mt-16">
            ...
            <div className="flex w-full mt-4 2xl:mt-8 space-between">
        ...
        <div className="p-12 2xl:p-4 basis-1/2">
      ...
      <div className="my-36">
        ...
        <div className="flex w-full justify-between items-bottom">
          <h4>Code snippets, walkthrough, opinions & case studies  </h4>
          <Filters2/>
        </div>
        <div className="mt-10">
          {posts.map((post, idx) => (
