...
links:
  - {
      title: Source Code,
      url: https://github.com/simoncarriere/simonsjournal-2022,
    }
  - { title: Live Link, url: https://simonsjournal.com }
---
...
- Next 12 (Waiting on dependencies to upgrade to V13)
- ContentLayer
- MDX
- Tailwind
- Framer
...
- Clean up the SEO, meta tags, and social images
- Enhance the SearchBar with Algolia for site wide text search
- Authenticate Users with Twitter and add a discussion section to each article
- Further, enhance component lifecycle animations with Framer Motion
- Track page views and add a "most read" section
- Extend my Cmd Pallette with actions. I’m experimenting with sending emails within the palette through a Q&A and booking appointments (using the google Calendar API).
- Build a recommendation section for articles using with graph theory.
